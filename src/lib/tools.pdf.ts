...
export const pdfTools: Tool[] = [
  {
    ...
    category: "pdf",
    keywords: ["merge pdf", "combine pdf", "join pdf", "pdf-lib"],
    path: "/pdf/merge-pdf",
    title: "Merge PDF Online — Browser Only | Prayas.dev",
    metaDescription:
      "Merge PDF files in your browser with pdf-lib. No upload. Reorder pages, then download one file.",
    h1: "Merge PDF",
    intro:
  ...
  },
  {
    ...
    category: "pdf",
    keywords: ["split pdf", "extract pages", "pdf range"],
    path: "/pdf/split-pdf",
    title: "Split PDF — Extract Pages in the Browser | Prayas.dev",
    metaDescription:
      "Extract PDF pages by range (1-3,5) in your browser. No upload.",
    h1: "Split PDF",
    intro:
  ...
  },
  {
    ...
    category: "pdf",
    keywords: ["compress pdf", "reduce pdf size", "pdf jpeg"],
    path: "/pdf/compress-pdf",
    title: "Compress PDF in the Browser | Prayas.dev",
    metaDescription:
      "Shrink a PDF by rasterizing pages to JPEG in your browser. Vector text becomes an image. No upload.",
    h1: "Compress PDF",
    intro:
  ...
  },
  {
    ...
    category: "pdf",
    keywords: ["rotate pdf", "pdf orientation", "landscape"],
    path: "/pdf/rotate-pdf",
    title: "Rotate PDF Pages in the Browser | Prayas.dev",
    metaDescription:
      "Rotate PDF pages clockwise in your browser. All pages or a range. No upload.",
    h1: "Rotate PDF",
    intro:
  ...
  },
  {
    ...
    category: "pdf",
    keywords: ["pdf to png", "pdf to jpg", "pdf render"],
    path: "/pdf/pdf-to-image",
    title: "PDF to PNG / JPEG / WebP in the Browser | Prayas.dev",
    metaDescription:
      "Turn PDF pages into PNG, JPEG, or WebP images locally with PDF.js. No upload.",
    h1: "PDF to image",
    intro:
